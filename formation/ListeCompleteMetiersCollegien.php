<?php
$PageTitle = "listeCompleteMetiersCollegien";
include __DIR__ . "/../../db/connexion.php";
include __DIR__ . "/../../includes/header.php";
include __DIR__ . "/../../models/FormationModel.php";
?>

<h1 style="text-shadow: 2px 2px 2px pink ;font-style: italic" class="text-center">Liste des Métiers_Collégien
</h1>
...
$selLCMC = new Formation();
function FselLCMC($selLCMC)
{
  try {
    $connexion = new Connexion();
    $pdostat = $connexion->query("SELECT * FROM formation WHERE  niveau IN (3,4) order by niveau ASC");
    $pdostat->setFetchMode(PDO::FETCH_ASSOC);
    $selLCMC = $pdostat->fetchAll();
    return $selLCMC;
  } catch (Exception $e) {
