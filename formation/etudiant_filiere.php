        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample"
            ...
            <div class="offcanvas-body">
                <div class="text-center">
                    ...
                    <figure>
                        <a href="http://localhost/CAMPUS_SELECT/views/formation/etudiant_metier.php">
    ...
    <div class="p-2 w-100 bd-highlight">
        <div>
            <button type="button" class="btn btn-dark"><a
                    href="http://localhost/CAMPUS_SELECT/views/formation/ListeCompletePB_etudiant.php"><strong
                        style="color: white;">Liste Complète
                        Patrimoine Bâti</strong> </a> </button>
        </div>
        <div>
            <form name="selectPB" action="traitementFiliere_PB_Etudiant.php" method="post" class="border border-dark"
        ...
        <div>
            <button type="button" class="btn btn-dark"><a
                    href="http://localhost/CAMPUS_SELECT/views/formation/ListeCompleteHT_etudiant.php"><strong
                        style="color: white;">Liste Complète
                        Horticulture-Paysage </strong> </a> </button>
        </div>
        <div>
            <form name="" action="traitementFiliere_HT_Etudiant.php" method="post" class="border border-dark"
                style="background-color: orange;">
                <div>
        ...
        <div>
            <button type="button" class="btn btn-dark"><a
                    href="http://localhost/CAMPUS_SELECT/views/formation/ListeCompleteAT_etudiant.php"><strong
                        style="color: white;">Liste Complète
                        Tourisme Patrimonial-Acceuil </strong> </a> </button>
        </div>
        <div>
            <form name="" action="traitementFiliere_AT_Etudiant.php" method="post" class="border border-dark"
                style="background-color: orange;">
                <div>
        ...
        <div>
            <button type="button" class="btn btn-dark"><a
                    href="http://localhost/CAMPUS_SELECT/views/formation/ListeCompleteG_etudiant.php"><strong
                        style="color: white;">Liste Complète
                        Gastronomie-Hotellerie-Cuisine</strong> </a> </button>
        </div>
        <div>
            <form name="" action="traitementFiliere_G_Etudiant.php" method="post" class="border border-dark"
                style="background-color: orange;">
                <div>
        ...
        <div>
            <button type="button" class="btn btn-dark"><a
                    href="http://localhost/CAMPUS_SELECT/views/formation/ListeCompleteAD_etudiant.php"><strong
                        style="color: white;">Liste Complète
                        Métiers d'Art et du design </strong> </a> </button>
        </div>
        <div>
            <form name="" action="traitementFiliere_AD_Etudiant.php" method="post" class="border border-dark"
                style="background-color: orange;">
                <div>
