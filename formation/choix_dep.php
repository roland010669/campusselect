...
<div class="p-2 w-100 bd-highlight">
    <div class="d-flex bd-highlight">
        <div class="p-2 w-100 bd-highlight">
            <h1 style="color: orange;" class="text-center"><u>Recherche Par Département-Collégien</u></h1>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample"
            ...
            <div class="offcanvas-body">
                <div class="text-center">
                    ...
                    <figure>
                        <a href="http://localhost/CAMPUS_SELECT/views/formation/metier.php"> <img
                    ...
                    <figure>
                        <a href="http://localhost/CAMPUS_SELECT/views/formation/affinite.php"><img
    ...
    <div class="p-2 w-100 bd-highlight">
        ...
        <div>
            <form name="selectPB" action="traitement_departementC.php" method="post" class="border    border-dark"
