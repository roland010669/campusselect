<?php
//session_start();
$PageTitle = "recherche par métier-lycéen";
...
<body>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
            ...
            <div class="offcanvas-body">
                <div class="text-center">
                    ...
                    <figure>
                        <a href="http://localhost/CAMPUS_SELECT/views/formation/lyceen_filiere.php">
                            <img src="../../Images/illustration métier_redimensionnée.jpg" alt="Homme sculptant" width="300" height="200">
                        </a>
                        <figcaption>Filière</figcaption>
                    </figure>
                    <figure>
                        <a href="http://localhost/CAMPUS_SELECT/views/formation/lyceen_affinite.php">
                            <img src="../../Images\représentation_affinité.jpg" alt="Homme sculptant" width="300" height="200"></a>
                        <figcaption>AFFINITÉ/CENTRE D'INTÉRÊT</figcaption>
                    </figure>
                    <figure>
                        <a href="http://localhost/CAMPUS_SELECT/views/formation/lyceen_departement.php"> <img src="../../Images\représentation_département_redim.jpg" alt="Homme taillant un arbre" width="300" height="200"></a>
    ...
    <hr>
    <div>
        <button type="button" class="btn btn-dark"><a href="ListeCompleteMetierLyceen.php"><strong style="color: white;">Liste Complète Des
                    Métiers-Lycéen</strong> </a> </button>
    </div>

    <form action="traitement_metier_lyceen.php" method="post" class="border border-dark" style="background-color: orange;">
        ...
        <div>
            ...
            <input class="form-control form-control-lg" type="text" aria-label=".form-control-lg example" id="nomMetier" name="nomMetier">
        </div>
        <div>
