<?php
$PageTitle = "listeCompleteGastronomie_Hotellerie_Cuisine-Lyceen";
...
<h1 style="text-shadow: 2px 2px 2px pink ;font-style: italic" class="text-center">Liste des Formations
    Gastronomie-Hotellerie-Cuisine-Lycéen
</h1>
...
$selLCGL = new Formation();
function FselLCGL($selLCGL)
{
  try {
    $connexion = new Connexion();
    $pdostat = $connexion->query("SELECT * FROM formation WHERE 	filiere='G'AND niveau IN ('3','4','5')");
    $pdostat->setFetchMode(PDO::FETCH_ASSOC);
    $selLCGL = $pdostat->fetchAll();
    return $selLCGL;
  } catch (Exception $e) {
