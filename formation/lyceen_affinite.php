<?php
$PageTitle = "recherche par affinité-lycéen";
include __DIR__ . "/../../includes/header.php";
?>
<div class="p-2 w-100 bd-highlight">
    <div class="d-flex bd-highlight">
        <div class="p-2 w-100 bd-highlight">
            <h1 style="color: orange;" class="text-center"><u>Recherche Par Affinité-Lycéen</u> </h1>
        ...
        <div>
            <form name="selectPB" action="affinite_traitement.php" method="post" class="border border-dark"
                ...
                <div>
                    ...
                    <input type="checkbox" name="sel[]" value="3">Niveau 5-DU_BTS<br>
                    <br>
                </div>
                <div>
