...
<head>
    ...
    <title>traitement_filièresAD_Etudiant</title>
</head>

<body>
    <?php
    $PageTitle = "traitement_filièresAD_Etudiant";
        ...
        function Fres()
        {
            ...
            if (count($tabsel) == 1) {
                ...
                if (in_array($tabsel[0], $tabDep)) {
                    try {
                        ...
                        $connexion = new Connexion();
                        $pdoStatement = $connexion->prepare("select * from formation where departement = :departement AND filiere='AD' AND niveau IN ('3','4','5','6')");
            ...
            if (count($tabsel) == 2) {
                ...
                try {
                    ...
                    $connexion = new Connexion();
                    $pdoStatement = $connexion->prepare("select * from formation where niveau = :niveau AND departement = :departement AND filiere='AD'");
    ...
    ?>
    <h1 style="color: orange;" class="text-center">Métiers d'Art et du design-Lycéen
    </h1>
