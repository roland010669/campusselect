<?php
//session_start();
$PageTitle = "recherche par métier-collégien";
...
<body>
    ...
    <div>
        <button type="button" class="btn btn-dark"><a
                href="http://localhost/CAMPUS_SELECT/views/formation/ListeCompleteMetiersCollegien.php"><strong
                    style="color: white;">Liste Complète Des
                    Métiers-Collégien</strong> </a> </button>
    </div>
    <form action="traitement_metierCollegien.php" method="post" class="border border-dark"
        style="background-color: orange;">
        <p><strong>Pour un Choix Ciblé,Faites une Recherche combinée : Métier (ET/OU)(NIVEAU/Département )</strong></p>
        <div>
            <label for="nomMetier">Veuillez choisir un métier dans la liste </label>
