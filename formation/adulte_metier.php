<?php
$PageTitle = "recherche par métier-adulte";
...
<body>
    ...
    <form name="selectMetier" id="metierSelection" action="traitement_Metier_Adulte.php" method="post" class="border border-dark" style="background-color: orange;">
        ...
        <div>
            ...
            <input type="checkbox" name="niveau[]" value="7">Niveau 7<br>
            <br>
        </div>
        <div>
