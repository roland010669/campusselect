<?php
$PageTitle = "recherche par département-Lycéen";
include __DIR__ . "/../../includes/header.php";
?>
<div class="p-2 w-100 bd-highlight">
    <div class="d-flex bd-highlight">
        <div class="p-2 w-100 bd-highlight">
            <h1 style="color: orange;" class="text-center"><u>Recherche Par Département-Lycéen</u></h1>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
            ...
            <div class="offcanvas-body">
                <div class="text-center">
                    ...
                    <figure>
                        <a href="http://localhost/CAMPUS_SELECT/views/formation/lyceen_metier.php"> <img src="../../Images/illustration métier_redimensionnée.jpg" alt="Homme sculptant" width="300" height="200">
                        </a>
                        <figcaption>Métier</figcaption>
                    </figure>
                    <figure>
                        <a href="http://localhost/CAMPUS_SELECT/views/formation/lyceen_affinite.php"><img src="../../Images\représentation_affinité.jpg" alt="Homme sculptant" width="300" height="200"> </a>
    ...
    <div class="p-2 w-100 bd-highlight">
        ...
        <div>
            <form action=" traitement_departement_lyceen.php" method="post" class="border    border-dark" style="background-color: orange;">
                <div>
                ...
                <div>
                    ...
                    <input type="checkbox" name="sel[]" value="5">Niveau 5-DU_BTS<br>
                    <br>
                </div>
