...
<head>
    ...
    <title>traitement_filièresAT_Etudiant</title>
</head>

<body>
    <?php
    $PageTitle = "traitement_filièresAT_Etudiant";
        ...
        function Fres()
        {
            ...
            if (count($tabsel) == 1) {
                ...
                if (in_array($tabsel[0], $tabDep)) {
                    try {
                        ...
                        $connexion = new Connexion();
                        $pdoStatement = $connexion->prepare("select * from formation where departement = :departement AND filiere='AT' AND niveau IN (3,4,5,6)");
            ...
            if (count($tabsel) == 2) {
                ...
                try {
                    ...
                    $connexion = new Connexion();
                    $pdoStatement = $connexion->prepare("select * from formation where niveau = :niveau AND departement = :departement AND filiere='AT'");
    ...
    ?>
    <h1 style="color: orange;" class="text-center">Tourisme Patrimonial-Acceuil-Lycéen
    </h1>
