<?php
$PageTitle = "recherche par affinité-adulte";
include __DIR__ . "/../../includes/header.php";
?>
<div class="p-2 w-100 bd-highlight">
    <div class="d-flex bd-highlight">
        <div class="p-2 w-100 bd-highlight">
            <h1 style="color: orange;" class="text-center"><u>Recherche Par Affinité-adulte</u> </h1>
                ...
                <div class="text-center">
                    ...
                    <figure>
                        <a href="http://localhost/CAMPUS_SELECT/views/formation/adulte_metier.php">
                            <img src="../../Images/illustration métier_redimensionnée.jpg" alt="Homme sculptant" width="300" height="200"> </a>
                        <figcaption>Métier</figcaption>
                    </figure>
                    <figure>
                        <a href="http://localhost/CAMPUS_SELECT/views/formation/adulte_departement.php"> <img src="../../Images\représentation_département_redim.jpg" alt="Homme taillant un arbre" width="300" height="200"></a>
    ...
    <div class="p-2 w-100 bd-highlight">
        <div>
            <form name="selectPB" action="affinite_traitement.php" method="post" class="border border-dark" style="background-color: orange;">
                <div>
                    <label for="nomMetier">saisir Affinité</label>
                    <input class="form-control form-control-lg" type="text" aria-label=".form-control-lg example" id="affinite" name="affinite">
                </div>
                <div>
