<?php
$PageTitle = "listeComplete_Métiers_d'Art_et_du_design_Adulte";
...
<h1 style="text-shadow: 2px 2px 2px pink ;font-style: italic" class="text-center">Liste des Formations
    Métiers d'Art et du design-Adulte.
</h1>
...
$selLADA = new Formation();
function FselLADA($selLADA)
{
  try {
    $connexion = new Connexion();
    $pdostat = $connexion->query("SELECT * FROM formation WHERE 	filiere='AD'AND niveau IN ('3','4','5','6','7')");
    $pdostat->setFetchMode(PDO::FETCH_ASSOC);
    $selLADA = $pdostat->fetchAll();
    return $selLADA;
  } catch (Exception $e) {
