<?php
$PageTitle = "listeCompleteGastronomie_Hotellerie_Cuisine-Etudiant";
include __DIR__ . "/../../db/connexion.php";
include __DIR__ . "/../../includes/header.php";
include __DIR__ . "/../../models/FormationModel.php";
?>

<h1 style="text-shadow: 2px 2px 2px pink ;font-style: italic" class="text-center">Liste des Formations
    Gastronomie-Hotellerie-Cuisine-Etudiant
</h1>
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <?php
$selLCGE = new Formation();
function FselLCGE($selLCGE)
{
  try {
    $connexion = new Connexion();
    $pdostat = $connexion->query("SELECT * FROM formation WHERE 	filiere='G'AND niveau IN ('3','4','5','6')");
    $pdostat->setFetchMode(PDO::FETCH_ASSOC);
    $selLCGE = $pdostat->fetchAll();
    return $selLCGE;
  } catch (Exception $e) {
