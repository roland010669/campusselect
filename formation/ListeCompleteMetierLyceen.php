<?php
$PageTitle = "listeCompleteMetiersLyceen";
include __DIR__ . "/../../db/connexion.php";
include __DIR__ . "/../../includes/header.php";
include __DIR__ . "/../../models/FormationModel.php";
?>

<h1 style="text-shadow: 2px 2px 2px pink ;font-style: italic" class="text-center">Liste des Métiers_Lycéen
</h1>
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <?php
$selLCML = new Formation();
function FselLCML($selLCML)
{
  try {
    $connexion = new Connexion();
    $pdostat = $connexion->query("SELECT * FROM formation WHERE  niveau IN (3,4,5) order by niveau ASC");
    $pdostat->setFetchMode(PDO::FETCH_ASSOC);
    $selLCML = $pdostat->fetchAll();
    return $selLCML;
  } catch (Exception $e) {
