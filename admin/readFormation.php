...
<body>
    ...
    <form action="readFormation_traitement.php" method="POST" name="formRead" id="formRead">
        ...
        <input style="background-color: #F4A94E1F;" class="form-control form-control-lg" type="text"
            aria-label=".form-control-lg example" id="metier" name="metier"><br>
        <button style="background-color:#62529c ;" type="submit" class="btn btn-secondary">VALIDER</button>
    </form>
